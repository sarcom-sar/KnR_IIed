...
executables = 1-01 1-02 1-03 1-04 1-05 1-06 1-07 1-08 1-09 1-10 1-11 1-12 1-13a 1-13b 1-14a 1-14b 1-15 1-16 1-17 1-18 1-19 1-20 1-21 1-22 1-23 1-24 2-01 2-02 2-03 2-04 2-05 2-06 2-07 2-08 2-09 2-10 3-01 3-02 3-03 3-04 3-05 3-06 4-01 4-02 4-03 4-04 4-05 4-06 4-07
...
4-03: $(SRC)/4-03.c $(SRC)/4-03func.c
4-04: $(SRC)/4-04.c $(SRC)/4-03func.c

4-05: $(SRC)/4-05.c $(SRC)/4-05func.c
	$(CC) $(CFLAGS) -o $(BUILD)/$@ $? -lm

4-06: $(SRC)/4-06.c $(SRC)/4-06func.c
	$(CC) $(CFLAGS) -o $(BUILD)/$@ $? -lm
